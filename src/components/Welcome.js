      ...
      {actLanguage === "GEO" && (
        <div>
          <Typography
            ...
            className={classes.slogan}
          >
            <b>კეთილიიყოსთქვენიმობრძანება!</b>
          </Typography>

          {!readMoreText1 && (
            <div>
              <Typography id="text1Litle" variant="body1">
                2016 წლიდან გვაქვს პატივი ულამაზეს ქალაქჰამბურგის
                მოსახლეობასდამის
                სტუმრებსუნიკალურიქართულისამზარეულოდასტუმართმოყვარეობაგავაცნოთ...
              </Typography>
              <p onClick={showTex1MoreHandler} style={{ cursor: "pointer" }}>
                ...წაიკითხე მეტი
              </p>
          ...
          {readMoreText1 && (
            <div>
              <Typography id="text1Big" variant="body1">
                ...
                <br />
                <br />
                ქართულისუფრათავისიმრავალფეროვანიკერძებითდაღვინოსფართოარჩევანითმსოფლიოშიფართოდ
                არის აღიარებული დაჩვენ გულითადათ გვსურდა, რომჩვენი რესტორანი
                ქართულიკულტურისადატრადიციულისტუმართმოყვარეობისიდეალურიგზამკვლევიგამხდარიყო.
                <br />
                <br />
                ჩვენთვის სასიხარულოა რომ ჩვენმა რესტორანმამოახერხა ჰამბურგის
                გასტრონომიის სფეროში წარმატებული ეტაბლირება და საპატიო ადგილის
                დაკავება.
                <br />
                <br />
                ჩვენი ახალგაზრდა გამოცდილი გუნდი არის მზად
                წვეულებებისადასადღესასწაულოსუფრისმენიუსშედგენისასგაითვალისწინოსჩვენისტუმრებისინდივიდუალურისურვილებიდა
                ამითმათი ჩვემთანსტუმრობალამაზდადაუვიწყარდღესასწაულად აქციონ.
                <br />
                <br />
                ჩვენთან თქვენ გელოდებათ სასიამოვნოგარემო სადაც შეგიძლიათ მოიწყოთ
                რომანტიულივახშამი, დაგეგმოთბიზნესლანჩიანკორპორატიულიწვეულება.
                <br />
                <br />
                მოხარულივიქნებითთქვენისტუმრობისა !
              </Typography>
              {/* <p onClick={showTex1LessHandler} style={{ cursor: "pointer" }}>
                  ...lesen weniger
                </p> */}
