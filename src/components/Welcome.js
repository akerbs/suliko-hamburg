      ...
      {actLanguage === "GEO" && (
        <div>
          <Typography
            ...
            className={classes.slogan}
          >
            <b>კეთილი იყოს თქვენი მობრძანება!</b>
          </Typography>

          {!readMoreText1 && (
            <div>
              <Typography id="text1Litle" variant="body1">
                2016 წლიდან გვაქვს პატივი ულამაზეს ქალაქ ჰამბურგის
                მოსახლეობას და მის სტუმრებს უნიკალური ქართული სამზარეულო და სტუმართმოყვარეობა გავაცნოთ...
              </Typography>
              <p onClick={showTex1MoreHandler} style={{ cursor: "pointer" }}>
                ...წაიკითხე მეტი
              </p>
            ...
            <div>
              <Typography id="text1Big" variant="body1">
               2016 წლიდან გვაქვს პატივი ულამაზეს ქალაქ ჰამბურგის
                ...
                <br />
                <br />
                ქართული სუფრა თავისი მრავალფეროვანი კერძებით და ღვინოს ფართო არჩევანით მსოფლიოში ფართოდ
                არის აღიარებული და ჩვენ გულითადათ გვსურდა, რომ ჩვენი რესტორანი
                ქართული კულტურისა და ტრადიციული სტუმართმოყვარეობის იდეალური გზამკვლევი გამხდარიყო.
                <br />
                <br />
                ...
                წვეულებებისა და სადღესასწაულო სუფრის მენიუს შედგენისას გაითვალისწინოს ჩვენი სტუმრების ინდივიდუალური სურვილები და
                ამით მათი ჩვემთან სტუმრობა ლამაზ და დაუვიწყარ დღესასწაულად აქციონ.
                <br />
                <br />
                ჩვენთან თქვენ გელოდებათ სასიამოვნო გარემო სადაც შეგიძლიათ მოიწყოთ
                რომანტიული ვახშამი, დაგეგმოთ ბიზნეს ლანჩი ან კორპორატიული წვეულება.
                <br />
                <br />
